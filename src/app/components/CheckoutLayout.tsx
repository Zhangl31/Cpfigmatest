...
const STEP_ROUTES = ['/', '/step1', '/step2', '/step3', '/step4', '/confirmation'];
...
export const CheckoutLayout = () => {
  ...
  const currentStep = location.pathname === '/' ? 1 : 
                      location.pathname === '/step1' ? 1 :
                      location.pathname === '/step2' ? 2 :
                      location.pathname === '/step3' ? 3 :
                      location.pathname === '/step4' ? 4 : 0;

  const showBottomBar = currentStep > 0 && currentStep < 5;
